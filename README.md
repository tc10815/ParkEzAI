...
In this project, functional requirements taken from a large class project is are being implemented with AI assitance is coding, writing, design and imagery.
...
When ParkEzAI began development, the ParkEz school project was mostly unimplemented, with only the frontend of the homepage, login page and new account page implemented with no backend. None of the code, design, text or images was used in ParkEzAI (only the functional requirements).
